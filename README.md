...
- [Risultati dell'Analisi](#-risultati-dell'analisi)
...
1. **Download dei Dati: Acquisizione dei dati storici per BTC-USD.**

2. **Calcolo dei Rendimenti: Trasformazione dei prezzi in rendimenti logaritmici.**

3. **Analisi della Volatilità Realizzata: Calcolo e visualizzazione della volatilità storica come benchmark.**

4. **Stima del Modello GARCH(1,1): Fitting del modello sui dati dei rendimenti.**

5. **Confronto e Validazione: Visualizzazione della volatilità prevista dal modello contro quella realizzata.**

6. **Forecast: Previsione della volatilità per i 30 giorni successivi.**
